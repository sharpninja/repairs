...
| [`moderate.test.mjs`](moderate.test.mjs) | Backend **moderation side effects** for approved PRs: `ai:approve` labeling, auto-merge, no explicit close, and failure comments/logging when GitHub cannot merge. | none (pure Node) |
