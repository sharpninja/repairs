...
import { adminHandler, mergeApprovedHandler } from "./admin.js";
...
const server = http.createServer((req, res) => {
  ...
  if (req.method === "POST" && path === "/admin/merge-approved") {
    mergeApprovedHandler(req, res).catch(() => { try { res.writeHead(500, { "content-type": "text/plain" }); res.end("error"); } catch (e) {} });
    return;
  }
